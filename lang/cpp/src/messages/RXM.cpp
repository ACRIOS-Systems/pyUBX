...
std::string ubx::RXM::IMES::getDescription(void) const {
    ...
    for (uint16_t i = 0; i < repeatedLen; i++) { ret << ", \"reserved2[" << i << "]\":" << "0" << ", \"txId[" << i << "]\":" << std::to_string(data.repeated[i].txId) << ", \"reserved3[" << i << "]\":" << "0" << ", \"cno[" << i << "]\":" << std::to_string(data.repeated[i].cno) << ", \"reserved4[" << i << "]\":" << "0" << ", \"doppler[" << i << "]\":" << std::to_string(data.repeated[i].doppler) << ", \"position1_1[" << i << "]\":" << std::to_string(data.repeated[i].position1_1) << ", \"_position1_1\":{\"pos1Floor\":" << std::to_string(data.repeated_position1_1_pos1Floor(i)) << ", \"pos1Lat\":" << std::to_string(data.repeated_position1_1_pos1Lat(i)) << "}" << ", \"position1_2[" << i << "]\":" << std::to_string(data.repeated[i].position1_2) << ", \"_position1_2\":{\"pos1Lon\":" << std::to_string(data.repeated_position1_2_pos1Lon(i)) << ", \"pos1Valid\":" << std::to_string(data.repeated_position1_2_pos1Valid(i)) << "}" << ", \"position2_1[" << i << "]\":" << std::to_string(data.repeated[i].position2_1) << ", \"_position2_1\":{\"pos2Floor\":" << std::to_string(data.repeated_position2_1_pos2Floor(i)) << ", \"pos2Alt\":" << std::to_string(data.repeated_position2_1_pos2Alt(i)) << ", \"pos2Acc\":" << std::to_string(data.repeated_position2_1_pos2Acc(i)) << ", \"pos2Valid\":" << std::to_string(data.repeated_position2_1_pos2Valid(i)) << "}" << ", \"lat[" << i << "]\":" << std::to_string(data.repeated[i].lat) << ", \"lon[" << i << "]\":" << std::to_string(data.repeated[i].lon) << ", \"shortIdFrame[" << i << "]\":" << std::to_string(data.repeated[i].shortIdFrame) << ", \"_shortIdFrame\":{\"shortId\":" << std::to_string(data.repeated_shortIdFrame_shortId(i)) << ", \"shortValid\":" << std::to_string(data.repeated_shortIdFrame_shortValid(i)) << ", \"shortBoundary\":" << std::to_string(data.repeated_shortIdFrame_shortBoundary(i)) << "}" << ", \"mediumIdLSB[" << i << "]\":" << std::to_string(data.repeated[i].mediumIdLSB) << ", \"mediumId_2[" << i << "]\":" << std::to_string(data.repeated[i].mediumId_2) << ", \"_mediumId_2\":{\"mediumIdMSB\":" << std::to_string(data.repeated_mediumId_2_mediumIdMSB(i)) << ", \"mediumValid\":" << std::to_string(data.repeated_mediumId_2_mediumValid(i)) << ", \"mediumboundary\":" << std::to_string(data.repeated_mediumId_2_mediumboundary(i)) << "}";}
    ret << "}";
    return ret.str();
}
uint8_t* ubx::RXM::IMES::getDataStartAddress(void) const { return (uint8_t*)&data; }
uint16_t ubx::RXM::IMES::getDataSize(void) const { return sizeof(data) + (repeatedLen * repeatedSize); }

void ubx::RXM::IMES::_data::repeated_position1_1_pos1Floor(uint8_t val, uint8_t n){ UBX_CHANGE_VAR_BIT(repeated[n].position1_1, val, RXM_IMES_REPEATED_POSITION1_1_POS1FLOOR_MASK, RXM_IMES_REPEATED_POSITION1_1_POS1FLOOR_OFFSET); }
uint8_t ubx::RXM::IMES::_data::repeated_position1_1_pos1Floor(uint8_t n)const{ return UBX_GET_VAR_BIT(repeated[n].position1_1, RXM_IMES_REPEATED_POSITION1_1_POS1FLOOR_MASK, RXM_IMES_REPEATED_POSITION1_1_POS1FLOOR_OFFSET); }
void ubx::RXM::IMES::_data::repeated_position1_1_pos1Lat(uint8_t val, uint8_t n){ UBX_CHANGE_VAR_BIT(repeated[n].position1_1, val, RXM_IMES_REPEATED_POSITION1_1_POS1LAT_MASK, RXM_IMES_REPEATED_POSITION1_1_POS1LAT_OFFSET); }
uint8_t ubx::RXM::IMES::_data::repeated_position1_1_pos1Lat(uint8_t n)const{ return UBX_GET_VAR_BIT(repeated[n].position1_1, RXM_IMES_REPEATED_POSITION1_1_POS1LAT_MASK, RXM_IMES_REPEATED_POSITION1_1_POS1LAT_OFFSET); }

void ubx::RXM::IMES::_data::repeated_position1_2_pos1Lon(uint8_t val, uint8_t n){ UBX_CHANGE_VAR_BIT(repeated[n].position1_2, val, RXM_IMES_REPEATED_POSITION1_2_POS1LON_MASK, RXM_IMES_REPEATED_POSITION1_2_POS1LON_OFFSET); }
uint8_t ubx::RXM::IMES::_data::repeated_position1_2_pos1Lon(uint8_t n)const{ return UBX_GET_VAR_BIT(repeated[n].position1_2, RXM_IMES_REPEATED_POSITION1_2_POS1LON_MASK, RXM_IMES_REPEATED_POSITION1_2_POS1LON_OFFSET); }
void ubx::RXM::IMES::_data::repeated_position1_2_pos1Valid(uint8_t val, uint8_t n){ UBX_CHANGE_VAR_BIT(repeated[n].position1_2, val, RXM_IMES_REPEATED_POSITION1_2_POS1VALID_MASK, RXM_IMES_REPEATED_POSITION1_2_POS1VALID_OFFSET); }
uint8_t ubx::RXM::IMES::_data::repeated_position1_2_pos1Valid(uint8_t n)const{ return UBX_GET_VAR_BIT(repeated[n].position1_2, RXM_IMES_REPEATED_POSITION1_2_POS1VALID_MASK, RXM_IMES_REPEATED_POSITION1_2_POS1VALID_OFFSET); }

void ubx::RXM::IMES::_data::repeated_position2_1_pos2Floor(uint8_t val, uint8_t n){ UBX_CHANGE_VAR_BIT(repeated[n].position2_1, val, RXM_IMES_REPEATED_POSITION2_1_POS2FLOOR_MASK, RXM_IMES_REPEATED_POSITION2_1_POS2FLOOR_OFFSET); }
uint8_t ubx::RXM::IMES::_data::repeated_position2_1_pos2Floor(uint8_t n)const{ return UBX_GET_VAR_BIT(repeated[n].position2_1, RXM_IMES_REPEATED_POSITION2_1_POS2FLOOR_MASK, RXM_IMES_REPEATED_POSITION2_1_POS2FLOOR_OFFSET); }
void ubx::RXM::IMES::_data::repeated_position2_1_pos2Alt(uint8_t val, uint8_t n){ UBX_CHANGE_VAR_BIT(repeated[n].position2_1, val, RXM_IMES_REPEATED_POSITION2_1_POS2ALT_MASK, RXM_IMES_REPEATED_POSITION2_1_POS2ALT_OFFSET); }
uint8_t ubx::RXM::IMES::_data::repeated_position2_1_pos2Alt(uint8_t n)const{ return UBX_GET_VAR_BIT(repeated[n].position2_1, RXM_IMES_REPEATED_POSITION2_1_POS2ALT_MASK, RXM_IMES_REPEATED_POSITION2_1_POS2ALT_OFFSET); }
void ubx::RXM::IMES::_data::repeated_position2_1_pos2Acc(uint8_t val, uint8_t n){ UBX_CHANGE_VAR_BIT(repeated[n].position2_1, val, RXM_IMES_REPEATED_POSITION2_1_POS2ACC_MASK, RXM_IMES_REPEATED_POSITION2_1_POS2ACC_OFFSET); }
uint8_t ubx::RXM::IMES::_data::repeated_position2_1_pos2Acc(uint8_t n)const{ return UBX_GET_VAR_BIT(repeated[n].position2_1, RXM_IMES_REPEATED_POSITION2_1_POS2ACC_MASK, RXM_IMES_REPEATED_POSITION2_1_POS2ACC_OFFSET); }
void ubx::RXM::IMES::_data::repeated_position2_1_pos2Valid(uint8_t val, uint8_t n){ UBX_CHANGE_VAR_BIT(repeated[n].position2_1, val, RXM_IMES_REPEATED_POSITION2_1_POS2VALID_MASK, RXM_IMES_REPEATED_POSITION2_1_POS2VALID_OFFSET); }
uint8_t ubx::RXM::IMES::_data::repeated_position2_1_pos2Valid(uint8_t n)const{ return UBX_GET_VAR_BIT(repeated[n].position2_1, RXM_IMES_REPEATED_POSITION2_1_POS2VALID_MASK, RXM_IMES_REPEATED_POSITION2_1_POS2VALID_OFFSET); }

void ubx::RXM::IMES::_data::repeated_shortIdFrame_shortId(uint8_t val, uint8_t n){ UBX_CHANGE_VAR_BIT(repeated[n].shortIdFrame, val, RXM_IMES_REPEATED_SHORTIDFRAME_SHORTID_MASK, RXM_IMES_REPEATED_SHORTIDFRAME_SHORTID_OFFSET); }
uint8_t ubx::RXM::IMES::_data::repeated_shortIdFrame_shortId(uint8_t n)const{ return UBX_GET_VAR_BIT(repeated[n].shortIdFrame, RXM_IMES_REPEATED_SHORTIDFRAME_SHORTID_MASK, RXM_IMES_REPEATED_SHORTIDFRAME_SHORTID_OFFSET); }
void ubx::RXM::IMES::_data::repeated_shortIdFrame_shortValid(uint8_t val, uint8_t n){ UBX_CHANGE_VAR_BIT(repeated[n].shortIdFrame, val, RXM_IMES_REPEATED_SHORTIDFRAME_SHORTVALID_MASK, RXM_IMES_REPEATED_SHORTIDFRAME_SHORTVALID_OFFSET); }
uint8_t ubx::RXM::IMES::_data::repeated_shortIdFrame_shortValid(uint8_t n)const{ return UBX_GET_VAR_BIT(repeated[n].shortIdFrame, RXM_IMES_REPEATED_SHORTIDFRAME_SHORTVALID_MASK, RXM_IMES_REPEATED_SHORTIDFRAME_SHORTVALID_OFFSET); }
void ubx::RXM::IMES::_data::repeated_shortIdFrame_shortBoundary(uint8_t val, uint8_t n){ UBX_CHANGE_VAR_BIT(repeated[n].shortIdFrame, val, RXM_IMES_REPEATED_SHORTIDFRAME_SHORTBOUNDARY_MASK, RXM_IMES_REPEATED_SHORTIDFRAME_SHORTBOUNDARY_OFFSET); }
uint8_t ubx::RXM::IMES::_data::repeated_shortIdFrame_shortBoundary(uint8_t n)const{ return UBX_GET_VAR_BIT(repeated[n].shortIdFrame, RXM_IMES_REPEATED_SHORTIDFRAME_SHORTBOUNDARY_MASK, RXM_IMES_REPEATED_SHORTIDFRAME_SHORTBOUNDARY_OFFSET); }

void ubx::RXM::IMES::_data::repeated_mediumId_2_mediumIdMSB(uint8_t val, uint8_t n){ UBX_CHANGE_VAR_BIT(repeated[n].mediumId_2, val, RXM_IMES_REPEATED_MEDIUMID_2_MEDIUMIDMSB_MASK, RXM_IMES_REPEATED_MEDIUMID_2_MEDIUMIDMSB_OFFSET); }
uint8_t ubx::RXM::IMES::_data::repeated_mediumId_2_mediumIdMSB(uint8_t n)const{ return UBX_GET_VAR_BIT(repeated[n].mediumId_2, RXM_IMES_REPEATED_MEDIUMID_2_MEDIUMIDMSB_MASK, RXM_IMES_REPEATED_MEDIUMID_2_MEDIUMIDMSB_OFFSET); }
void ubx::RXM::IMES::_data::repeated_mediumId_2_mediumValid(uint8_t val, uint8_t n){ UBX_CHANGE_VAR_BIT(repeated[n].mediumId_2, val, RXM_IMES_REPEATED_MEDIUMID_2_MEDIUMVALID_MASK, RXM_IMES_REPEATED_MEDIUMID_2_MEDIUMVALID_OFFSET); }
uint8_t ubx::RXM::IMES::_data::repeated_mediumId_2_mediumValid(uint8_t n)const{ return UBX_GET_VAR_BIT(repeated[n].mediumId_2, RXM_IMES_REPEATED_MEDIUMID_2_MEDIUMVALID_MASK, RXM_IMES_REPEATED_MEDIUMID_2_MEDIUMVALID_OFFSET); }
void ubx::RXM::IMES::_data::repeated_mediumId_2_mediumboundary(uint8_t val, uint8_t n){ UBX_CHANGE_VAR_BIT(repeated[n].mediumId_2, val, RXM_IMES_REPEATED_MEDIUMID_2_MEDIUMBOUNDARY_MASK, RXM_IMES_REPEATED_MEDIUMID_2_MEDIUMBOUNDARY_OFFSET); }
uint8_t ubx::RXM::IMES::_data::repeated_mediumId_2_mediumboundary(uint8_t n)const{ return UBX_GET_VAR_BIT(repeated[n].mediumId_2, RXM_IMES_REPEATED_MEDIUMID_2_MEDIUMBOUNDARY_MASK, RXM_IMES_REPEATED_MEDIUMID_2_MEDIUMBOUNDARY_OFFSET); }
const uint16_t ubx::RXM::IMES::repeatedSize = sizeof(struct ubx::RXM::IMES::_data::_repeated);
