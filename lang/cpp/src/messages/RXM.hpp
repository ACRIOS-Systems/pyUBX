...
#define RXM_IMES_REPEATED_POSITION1_1_POS1FLOOR_OFFSET (0)
#define RXM_IMES_REPEATED_POSITION1_1_POS1FLOOR_MASK (255)
#define RXM_IMES_REPEATED_POSITION1_1_POS1LAT_OFFSET (8)
#define RXM_IMES_REPEATED_POSITION1_1_POS1LAT_MASK (2147483392)

#define RXM_IMES_REPEATED_POSITION1_2_POS1LON_OFFSET (0)
#define RXM_IMES_REPEATED_POSITION1_2_POS1LON_MASK (16777215)
#define RXM_IMES_REPEATED_POSITION1_2_POS1VALID_OFFSET (24)
#define RXM_IMES_REPEATED_POSITION1_2_POS1VALID_MASK (16777216)

#define RXM_IMES_REPEATED_POSITION2_1_POS2FLOOR_OFFSET (0)
#define RXM_IMES_REPEATED_POSITION2_1_POS2FLOOR_MASK (511)
#define RXM_IMES_REPEATED_POSITION2_1_POS2ALT_OFFSET (9)
#define RXM_IMES_REPEATED_POSITION2_1_POS2ALT_MASK (2096640)
#define RXM_IMES_REPEATED_POSITION2_1_POS2ACC_OFFSET (21)
#define RXM_IMES_REPEATED_POSITION2_1_POS2ACC_MASK (6291456)
#define RXM_IMES_REPEATED_POSITION2_1_POS2VALID_OFFSET (23)
#define RXM_IMES_REPEATED_POSITION2_1_POS2VALID_MASK (8388608)

#define RXM_IMES_REPEATED_SHORTIDFRAME_SHORTID_OFFSET (0)
#define RXM_IMES_REPEATED_SHORTIDFRAME_SHORTID_MASK (4095)
#define RXM_IMES_REPEATED_SHORTIDFRAME_SHORTVALID_OFFSET (12)
#define RXM_IMES_REPEATED_SHORTIDFRAME_SHORTVALID_MASK (4096)
#define RXM_IMES_REPEATED_SHORTIDFRAME_SHORTBOUNDARY_OFFSET (13)
#define RXM_IMES_REPEATED_SHORTIDFRAME_SHORTBOUNDARY_MASK (8192)

#define RXM_IMES_REPEATED_MEDIUMID_2_MEDIUMIDMSB_OFFSET (0)
#define RXM_IMES_REPEATED_MEDIUMID_2_MEDIUMIDMSB_MASK (1)
#define RXM_IMES_REPEATED_MEDIUMID_2_MEDIUMVALID_OFFSET (1)
#define RXM_IMES_REPEATED_MEDIUMID_2_MEDIUMVALID_MASK (2)
#define RXM_IMES_REPEATED_MEDIUMID_2_MEDIUMBOUNDARY_OFFSET (2)
#define RXM_IMES_REPEATED_MEDIUMID_2_MEDIUMBOUNDARY_MASK (4)
...
struct __attribute__((packed)) IMES : public SerializeCommon
{
    ...
    struct __attribute__((packed)) _data {
        ...
        void repeated_mediumId_2_mediumIdMSB(uint8_t val, uint8_t n);
        uint8_t repeated_mediumId_2_mediumIdMSB(uint8_t n) const;
        void repeated_mediumId_2_mediumValid(uint8_t val, uint8_t n);
        uint8_t repeated_mediumId_2_mediumValid(uint8_t n) const;
        void repeated_mediumId_2_mediumboundary(uint8_t val, uint8_t n);
        uint8_t repeated_mediumId_2_mediumboundary(uint8_t n) const;
    } data;
};
