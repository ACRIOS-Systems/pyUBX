...
// Auto-generated by pyUBX generateCPP.py v0.2 on 2024-06-10T11:04:46.590665
    ...
    switch(classId)
    {
        ...
        case ::MGA::classID: // Message class MGA
        {
            switch(messageID)
            {
                ...
                case MGA::INI_TIME_UTC::messageID: // Message MGA-INI_TIME_UTC
                {
                    ret = shared_ptr<MGA::INI_TIME_UTC>(new MGA::INI_TIME_UTC);
                    break;
                }
                default:
                {
        ...
        case ::MON::classID: // Message class MON
        {
            switch(messageID)
            {
                case MON::HW::messageID: // Message MON-HW
                {
                    if (isGet)
                    {
                        ret = shared_ptr<MON::HW_GET>(new MON::HW_GET);
                    }
                    else
                    {
        ...
        case ::RXM::classID: // Message class RXM
        {
            switch(messageID)
            {
                ...
                {
                    uint8_t *heap = new uint8_t[sizeof(RXM::IMES) + (len - sizeof(struct RXM::IMES::_data))];
                    ret = shared_ptr<RXM::IMES>(new (heap) RXM::IMES);
                    dynamic_cast<RXM::IMES*>(ret.get())->repeatedLen = (len - sizeof(struct RXM::IMES::_data)) / sizeof(struct RXM::IMES::_data::_repeated);
                    break;
                }
